 ...
 */
@Slf4j
public class TopicExchangeProducer extends BaseProducer {
    ...
    public TopicExchangeProducer(String producerName, String exchangeName, String[][] bindRoutingKeys, String[] queueNames) {
        super(producerName);
    ...
    private void init() {
        ...
        for (int i=0; i < queueNames.length; i++) {
            ...
            String[] bindRoutingKeyArray =  bindRoutingKeys[i];
            /*
             * 生成一个队列
             * 1.队列名称
            ...
            // 绑定队列到交换机，使用多个RoutingKey
            for (String s : bindRoutingKeyArray) {
